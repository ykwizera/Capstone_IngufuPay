...
import { X, Send, MapPin, User, FileText, ChevronRight } from "lucide-react"
    ...
    <div className="modal-overlay" onClick={e => e.target === e.currentTarget && onClose()}>
      <div className="modal rm-modal">
        ...
        {step === 2 && (
          <div className="rm-body">
            <div className="rm-section-label">
              <MapPin size={13} /> Installation Location
            </div>
          ...
          <div className="rm-body">
            <div className="rm-success">
              ...
              <div className="rm-success-sub">
                ...
                and you will be notified by email once it is approved or rejected.
              ...
              <div className="rm-success-details">
                ...
                <div className="rm-success-detail-row">
                  <span>Reason</span>
                  <strong>{REASONS.find(r => r.value === form.reason)?.label}</strong>
                </div>
              </div>
